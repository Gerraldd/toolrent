...
export async function DELETE(request: NextRequest) {
    try {
        ...
        // Delete all pengembalian with the given IDs
        const result = await prisma.pengembalian.deleteMany({
            where: {
                id: {
                    in: ids
                }
        ...
        await prisma.logAktivitas.create({
            data: {
                ...
                tabel: 'pengembalian',
                recordId: null,
                deskripsi: `Menghapus ${result.count} data pengembalian secara massal`,
        ...
        console.error('Error in bulk delete pengembalian:', error)
        return NextResponse.json(
